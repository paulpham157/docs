...
<div style={{ position: 'relative', paddingTop: '56.25%' }}>
  <iframe
    src="https://capture.navattic.com/cmdqcbvog000304ju6ku3c6nd"
...
> Note: The interactive demo above isn’t supported on smaller screens, but you can [click here](https://mixpanel.navattic.com/3sk0ug6) to open the experience in a new window.
...
- **Block Events**: To prevent an event from being ingested entirely, [block it](/docs/data-governance/lexicon#blocking-data) in Lexicon.
...
| Inconsistent naming | Harder to find and interpret data across teams. | Enforce naming standards using [Data Standards](/docs/data-governance/data-standards) and [Lexicon](/docs/data-governance/lexicon) descriptions. |
| Lack of cleanup process | Outdated or duplicate events clutter reports and reduce trust. | Schedule periodic reviews and [hide](/docs/data-governance/lexicon#hiding-data) or [block](/docs/data-governance/lexicon#blocking-data) deprecated data. |
