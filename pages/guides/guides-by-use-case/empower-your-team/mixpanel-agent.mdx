...
New to Mixpanel Agent? Take a quick interactive walkthrough before diving into the details.
<br></br>
<div style={{ position: 'relative', paddingTop: '56.25%' }}>
  <iframe
    src="https://capture.navattic.com/cmpczy8fy000a0bkz1rlh27l6"
    title="Navattic walkthrough"
    style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', border: 0 }}
    data-navattic-demo-id="cmdqcbvog000304ju6ku3c6nd"
    allowFullScreen
  />
</div>

> Note: The interactive demo above isn’t supported on smaller screens, but you can [click here](https://mixpanel.navattic.com/smr0zaw) to open the experience in a new window.
...
<Callout type="info">
    **Pro tip:** The RCA Agent uses your Business Context when it's configured — pulling from both your Organization and Project settings. Cyclical patterns, seasonality, and known launches are all factored into its reasoning, so a traffic spike on Black Friday gets interpreted differently than an unexplained one.
</Callout>
...
<Callout type="warning">
    The KPI Agent is set up and managed directly from the KPI Agent interface — creating or managing it through Mixpanel Agent is coming soon. At launch, it supports [Insights](/docs/reports/insights)-based queries on a daily, weekly, or monthly cadence. Funnel and Retention report support is coming soon as well.
</Callout>
...
| Open Mixpanel every morning to check if anything moved | KPI Agent | It comes to you — daily, weekly, or monthly, via Slack or email. You know where to dig in. |
...
| **Delivery** | In-product | In-product | Slack or email | In-product |
