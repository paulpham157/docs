...
If you are offering experiments or A/B tests to your customers, add support for [auto-populating our Experiments report](/docs/experiments) to your integration in order to reduce time-to-value for our mutual customers.
