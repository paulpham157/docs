...
See [Audit Log Reference](/docs/access-security/audit-log/audit-log-reference) for a comprehensive list of all tracked events, including descriptions and availability dates.
