...
<Callout type="info">
  The audit log is available on all plans. Free and Growth plans retain logs for
  90 days. Enterprise plans retain logs for 2 years. See our [pricing
...
See [Audit Log Reference](/docs/access-security/audit-log/audit-log-reference) for a complete list of all tracked events, including descriptions and availability dates.
