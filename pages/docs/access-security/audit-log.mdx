...
| Event Type                       | Display Name                 | Description                                      | Available Since |
| -------------------------------- | ---------------------------- | ------------------------------------------------ | --------------- |
| `bookmark.created`               | Report Saved                 | A new report was saved to a dashboard            | April 5, 2026   |
...
| `profile.batch_deleted`       | Profile Deleted              | A batch of user profiles were removed               | May 20, 2026    |
| `profile.batch_updated`       | Profile Updated              | A batch of user profiles were updated               | May 20, 2026    |
