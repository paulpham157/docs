...
The project API secret is deprecated and will be retired on **March 3rd, 2027**. For new projects or integrations, use [Service Accounts](https://developer.mixpanel.com/reference/service-accounts) instead. Existing API‑secret workflows will continue to work until retirement, but should be migrated when convenient.
</Callout>
