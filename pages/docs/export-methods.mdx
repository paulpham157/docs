...
```
# Returning "sample_event" from 2026-01-10 to 2026-01-11
curl -gG --request GET \
     --url 'https://data.mixpanel.com/api/2.0/export?from_date=2026-01-10&to_date=2026-01-11&limit=100' \
     --data-urlencode 'event=["sample_event"]' \
...
Exports from the UI are limited to 50,000 results and only the columns shown in the UI will be exported in the CSV. You may modify the table by clicking the “Edit Columns” button to choose the profile properties to return before your export.
